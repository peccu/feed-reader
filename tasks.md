...
- [ ] 記事表示ビューで、評価済みのものはその評価がわかるようにアクションボタンの表記を変更してください。具体的にはライブラリから既読のものを開いた時に、すでにlike/dislike評価済みのものがアクションボタンの色が変わっておらず、未評価に見えてまた評価してしまいます。
- [ ] ライブラリから記事を開いた時に戻るためのボタンの位置と、ライブラリから戻るためのボタンの位置が異なる。記事に表示されているボタンの位置の方が好み
- [ ] 右手と左手の切替でメニュー、戻るボタンの位置が変わらないです
